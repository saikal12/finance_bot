...
def main():
    ...
    application.add_handler(MessageHandler(filters.Regex(ru_translations["choose_language_command"]), choose_lang)) #for ru not work
    application.add_handler(MessageHandler(filters.Regex(ru_translations["help_text"]), help_command))
    application.add_handler(MessageHandler(filters.Regex(ru_translations["filter_checks_command"]), filter_receipt))
